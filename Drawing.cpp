...
Model cube = Model("models/cube",glm::vec3(0.75,1.6,-1.2), 0.75);
...
int main(int argc, char* argv[])
{
  ...
  tris.reserve(sphere.tris.size() + model.tris.size() + logo.tris.size() + cube.tris.size());
  ...
  tris.insert(tris.end(), cube.tris.begin(), cube.tris.end());
